...
con.connect(function(err) {
  ...
  sql = "INSERT INTO bookclub.books (title, author, year, country, summary, genre, cover) VALUES ('Women Dont Owe You Pretty', 'Florence Given', 2020, null, 'The ultimate book for anyone who wants to challenge the out-dated narratives supplied to us by the patriarchy. Through Florences story you will learn how to protect your energy, discover that you are the love of your own life, and realise that today is a wonderful day to dump them.', 'lifestyle', 'https://images-na.ssl-images-amazon.com/images/I/41m1-HIUglL._SX322_BO1,204,203,200_.jpg');";
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table creation `items` was successful!");
