...
con.connect(function(err) {
  ...
  let sql = 
  "DROP TABLE if exists books; CREATE TABLE books(id int auto_increment primary key, title text null, author text null, year int null, country text null, location text null, summary text null, genre text null, cover text null);";
  con.query(sql, function (err, result) {
    ...
    sql = 
    "INSERT INTO bookclub.books (title, author, year, country, location, summary, genre, cover) VALUES ('The Testaments', 'Margaret Atwood', 2019, 'Canada', 'Madrid Spain', 'More than fifteen years after the events of The Handmaid s Tale, the theocratic regime of the Republic of Gilead maintains its grip on power, but there are signs it is beginning to rot from within.', 'fiction', 'https://images-na.ssl-images-amazon.com/images/I/41-m9MGUgoL._SX325_BO1,204,203,200_.jpg');";
    con.query(sql, function (err, result) {
      if (err) throw err;
  ...
  sql = "INSERT INTO bookclub.books (title, author, year, country, location, summary, genre, cover) VALUES ('Girl, Woman, Other', 'Bernardine Evaristo', 2019, 'United-States', 'Santiago de Compostela Spain', 'This is Britain as you''ve never read it. This is Britain as it has never been told. From Newcastle to Cornwall, from the birth of the twentieth century to the teens of the twenty-first, Girl, Woman, Other follows a cast of twelve characters on their personal journeys through this country and the last hundred years. They''re each looking for something - a shared past, an unexpected future, a place to call home, somewhere to fit in, a lover, a missed mother, a lost father, even just a touch of hope.', 'fiction', 'https://images-na.ssl-images-amazon.com/images/I/51ahH0NU6BL._SX324_BO1,204,203,200_.jpg');";
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table creation `items` was successful!");
  ...
  sql = "INSERT INTO bookclub.books (title, author, year, country, location, summary, genre, cover) VALUES ('Everything I Know About Love', 'Dolly Alderton', 2018, 'United-Kingdom', 'Valencia Spain', 'When it comes to the trials and triumphs of becoming a grown up, journalist Dolly Alderton has seen and tried it all. She vividly recounts falling in love, wrestling with self-sabotage, finding a job, throwing a socially disastrous Rod-Stewart themed house party, getting drunk, getting dumped, realising that Ivan from the corner shop is the only man you''ve ever been able to rely on, and finding that that your mates are always there at the end of every messy night out. It''s a book about bad dates, good friends and - above all else - about recognising that you and you alone are enough.', 'autobiography', 'https://images-na.ssl-images-amazon.com/images/I/51e2-LIM3aL._SX324_BO1,204,203,200_.jpg');";
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table creation `items` was successful!");
  ...
  sql = "INSERT INTO bookclub.books (title, author, year, country, location, summary, genre, cover) VALUES ('The Truth about the Harry Quebert Affair', 'Joël Dicker', 2012, 'Switzerland', 'Cartagena Spain', 'That summer, struggling author Harry Quebert fell in love with fifteen-year-old Nola Kellergan. Thirty-three years later, her body is dug up from his yard, along with a manuscript copy of the novel that made him a household name. Quebert is the only suspect.', 'fiction', 'https://images-na.ssl-images-amazon.com/images/I/51s8afPWtHL._SX325_BO1,204,203,200_.jpg');";
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table creation `items` was successful!");
  ...
  sql = "INSERT INTO bookclub.books (title, author, year, country, location, summary, genre, cover) VALUES ('Women Dont Owe You Pretty', 'Florence Given', 2020, null, 'San Sebastian Spain', 'The ultimate book for anyone who wants to challenge the out-dated narratives supplied to us by the patriarchy. Through Florences story you will learn how to protect your energy, discover that you are the love of your own life, and realise that today is a wonderful day to dump them.', 'lifestyle', 'https://images-na.ssl-images-amazon.com/images/I/41m1-HIUglL._SX322_BO1,204,203,200_.jpg');";
  con.query(sql, function (err, result) {
    if (err) throw err;
    console.log("Table creation `items` was successful!");
